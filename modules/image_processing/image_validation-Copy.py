...
def validate_question_images(questions: List[Dict[str, Any]]) -> Tuple[bool, List[str]]:
    ...
    for question in questions:
        ...
        for item in content_items:
            ...
            # if "JustDropDown:" in content:
            #     image_markers["JustDropDown"] = True
        ...
        if q_type == "HOTSPOT":
            ...
            # Check if this is a Type 2 DROPDOWN (with JustDropDown marker)
            # is_type2 = "JustDropDown" in image_markers
            
            # if is_type2:
            #     # Type 2 DROPDOWN requires QuestionDescriptionImage, JustDropDown, and AnswerOptionImage
            #     if "QuestionDescriptionImage" not in image_markers:
            #         error_messages.append(f"Question {q_number} (DROPDOWN Type 2) - Missing QuestionDescriptionImage")
            #         all_valid = False
                
            #     if "JustDropDown" not in image_markers:
            #         error_messages.append(f"Question {q_number} (DROPDOWN Type 2) - Missing JustDropDown")
            #         all_valid = False
                
            #     if "AnswerOptionImage" not in image_markers:
            #         error_messages.append(f"Question {q_number} (DROPDOWN Type 2) - Missing AnswerOptionImage")
            #         all_valid = False
            # else:
                # Type 1 DROPDOWN requires QuestionOptionImage and AnswerOptionImage
            if "QuestionOptionImage" not in image_markers:

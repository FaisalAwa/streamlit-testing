...
#         # Check if this is a JustDropDown question
#         has_just_dropdown = self._has_just_dropdown_marker()
...
#         question_data = []
#         if q_images:
#             question_data = self._extract_dropdown_questions_from_image(
#                 q_images[0]["data"], 
#                 has_just_dropdown
#             )
...
#         self._add_dropdown_options_to_xml(root, question_data, has_just_dropdown)
#         self._add_dropdown_answers_to_xml(root, answers_data, a_images)
    
#     def _has_just_dropdown_marker(self) -> bool:
#         """Check if this question has JustDropDown marker"""
#         return any("JustDropDown" in item.get("content", "") for item in self.content_items)
...
#             if "question" in str(img_types) or "justdropdown" in str(img_types):
#                 q_images.append(img)
...
#     def _extract_dropdown_questions_from_image(self, image_data: bytes, is_just_dropdown: bool) -> List[Dict]:
#         """Extract dropdown questions from image"""
#         from modules.image_processing.image_processor import extract_dropdown_questions
#         raw_data = extract_dropdown_questions(image_data, is_just_dropdown=is_just_dropdown)
...
#     def _add_dropdown_options_to_xml(self, root: ET.Element, question_data: List[Dict], has_just_dropdown: bool):
#         """Add dropdown options to XML"""
#         options_elem = ET.SubElement(root, "QuestionOptions")
        
#         if has_just_dropdown:
#             self._add_just_dropdown_options(options_elem, question_data)
#         else:
#             self._add_normal_dropdown_options(options_elem, question_data)
    
#     def _add_just_dropdown_options(self, options_elem: ET.Element, question_data: List[Dict]):
#         """Add JustDropDown options to XML"""
#         try:
#             for idx, item in enumerate(question_data, start=1):
...
#                 ET.SubElement(option_set, "ColumnHeaderStatement").text = ""
#                 ET.SubElement(option_set, "Statement").text = label
#                 ET.SubElement(option_set, "ColumnHeaderOptions").text = ""
                
#                 opts_parent = ET.SubElement(option_set, "Options")
#                 for opt in options_list:
#                     ET.SubElement(opts_parent, "Option").text = str(opt)
#         except Exception as e:
#             st.error(f"Error processing JustDropDown data: {str(e)}")
    
#     def _add_normal_dropdown_options(self, options_elem: ET.Element, question_data: List[Dict]):
#         """Add normal dropdown options to XML"""
